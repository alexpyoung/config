...
class Configuration {
    ...
    load() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // neovim
            let neovimErrors = yield configurationValidator_1.configurationValidator.isNeovimValid(exports.configuration.enableNeovim, exports.configuration.neovimPath);
            ...
            if (neovimErrors.filter(e => e.level === 'error').length > 0) {
                ...
                exports.configuration.enableNeovim = false;
            }
            // wrap keys
            this.wrapKeys = {};
